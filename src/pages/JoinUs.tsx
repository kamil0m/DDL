        ...
        <section className="flex flex-col mt-20">
            <div className="flex flex-col gap-8">
                <div className="flex flex-col gap-2">
                    ...
                    <p className="">Explain here what your future members need to do to join our association. Can be a long description or not, it’s up to you to decide. Just make sure it’s transparent, not too long, not too detailed, with just enough informations for people to choose you.</p>
                </div>
                <div className="flex flex-col gap-2">
                    <h4>Why join us</h4>

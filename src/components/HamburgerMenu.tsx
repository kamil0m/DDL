  ...
  return (
    <>
        ...
        <nav 
            id="navbar__mobile"
            className="
            hidden animate-fade-in-down flex flex-col items-center justify-center absolute left-0 top-0 w-full bg-white h-screen z-10 uppercase font-semibold text-2xl gap-6"
            onClick={() => toggleMenu()} 
            >

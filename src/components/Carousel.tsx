...
//     // const handleLeft = () => {
//     //     if (canGoLeft) setStartIndex(Math.max(0, startIndex - step));
//     // };

//     // const handleRight = () => {
//     //     if (canGoRight) {
//     //         const nextIndex = startIndex + step;
//     //         setStartIndex(nextIndex + maxVisible > dataArray.length
...
//     const handleRight = () => {
//         setStartIndex(Math.min(startIndex + step, dataArray.length - maxVisible));
//     };

            ...
            <div className="flex flex-col justify-center w-1/2 gap-6">
                ...
                <div className="flex flex-col gap-6">
                    ...
                    <div className="fb-box">
                        <a href="https://www.facebook.com/groups/1403266290513975" target="_blank" className="fb-icon-wrapper">
                            <BiLogoFacebookCircle className="text-blue-600 text-4xl" />
                        </a>
                        <div>
                            <a href="https://www.facebook.com/groups/1403266290513975" target="_blank" className="fb-title">{t("contact.facebookgroup")}</a>
                    ...
                    {/* Facebook page */}
                    <div className="fb-box">
                        <a href="https://www.facebook.com/profile.php?id=61559848594019" target="_blank" className="fb-icon-wrapper">
                            <BiLogoFacebookCircle className="text-blue-600 text-4xl" />
                        </a>
                        <div>
                            <a href="https://www.facebook.com/profile.php?id=61559848594019" target="_blank" className="fb-title">{t("contact.facebookpage")}</a>

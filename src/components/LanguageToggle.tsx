...
export default function LanguageToggle({ onLanguageChange }: LanguageToggleProps) {
    ...
    return (
        ...
        >
            ...
            <span className={`z-10 switch ${i18n.language === "fr" ? "text-red" : ""} language-toggle-label`}>FR</span>
            <span className={`z-10 switch ${i18n.language === "pl" ? "text-red" : ""} language-toggle-label`}>PL</span>
        </label>
    )
}